...
if [ $stage -le 18 ]; then
  ...
  tdnnf-layer name=tdnnf7a $tdnnf_first_opts dim=1536 bottleneck-dim=256 time-stride=0
  tdnnf-layer name=tdnnf8a $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf9a $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf10a $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf11a $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf12a $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf13a $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf14a $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf15a $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf16a $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf17a $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3   

  tdnnf-layer name=tdnnf7b input=cnn6 $tdnnf_first_opts dim=1536 bottleneck-dim=256 time-stride=0
  tdnnf-layer name=tdnnf8b $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=2
  tdnnf-layer name=tdnnf9b $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=2
  tdnnf-layer name=tdnnf10b $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=2
  tdnnf-layer name=tdnnf11b $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=2
  tdnnf-layer name=tdnnf12b $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=2
  tdnnf-layer name=tdnnf13b $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=2
  tdnnf-layer name=tdnnf14b $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=2
  tdnnf-layer name=tdnnf15b $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=2
  tdnnf-layer name=tdnnf16b $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=2
  tdnnf-layer name=tdnnf17b $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=2   
  attention-relu-batchnorm-layer input=tdnnf17b name=attention1 time-stride=2 num-heads=12 value-dim=120 key-dim=80 num-left-inputs=4 num-right-inputs=4  

  tdnnf-layer name=tdnnf7c input=cnn6 $tdnnf_first_opts dim=1536 bottleneck-dim=256 time-stride=0
  tdnnf-layer name=tdnnf8c $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=1
  tdnnf-layer name=tdnnf9c $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=2
  tdnnf-layer name=tdnnf10c $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=2
  tdnnf-layer name=tdnnf11c $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=2
  tdnnf-layer name=tdnnf12c $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=2
  tdnnf-layer name=tdnnf13c $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf14c $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf15c $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf16c $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf17c $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3   
  
  linear-component name=prefinal-l dim=256 $linear_opts input=Append(tdnnf17a, attention1, tdnnf17c)
...
if [ $stage -le 19 ]; then
  ...
  steps/nnet3/chain/train.py --stage $train_stage \
    --cmd "$decode_cmd" \
    --feat.online-ivector-dir exp/nnet3${nnet3_suffix}/ivectors_train_sp_aug_hires \
...
#graph_dir=$dir/graph
  ...
  #for test in {intervjuud,jutusaated,ak,er,paevakaja,ekskfk,konverentsid,seeniorid,www-trans,podcasts}.{devset,testset}; do
       #steps/nnet3/decode.sh --acwt 1.0 --post-decode-acwt 10.0  \
          ...
          #--online-ivector-dir exp/nnet3${nnet3_suffix}/ivectors_${test} \
